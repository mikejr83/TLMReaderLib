...
public class HeaderDataBlockTest {
	...
	public void testGetSensorTypeEnabledInvalidMarker() {
		byte[] testBlock = new DataBlockBuilder(0, 0x0102).get();
	...
	public void testGetSensorTypeEnabledVolt() {
		byte[] testBlock = new DataBlockBuilder(0, VOLT_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledTemperature() {
		byte[] testBlock = new DataBlockBuilder(0, TEMPERATURE_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledAmps() {
		byte[] testBlock = new DataBlockBuilder(0, AMPS_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledPowerBox() {
		byte[] testBlock = new DataBlockBuilder(0, POWERBOX_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledSpeed() {
		byte[] testBlock = new DataBlockBuilder(0, SPEED_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledAltimeter() {
		byte[] testBlock = new DataBlockBuilder(0, ALTIMETER_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledGForce() {
		byte[] testBlock = new DataBlockBuilder(0, GFORCE_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledJetCat() {
		byte[] testBlock = new DataBlockBuilder(0, JETCAT_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledGPS() {
		byte[] testBlock = new DataBlockBuilder(0, GPS_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledTerminatingBlock() {
		byte[] testBlock = new DataBlockBuilder(0, TERMINATING_BLOCK_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
	...
	public void testGetSensorTypeEnabledUnknownHeaderMarker() {
		byte[] testBlock = new DataBlockBuilder(0, UNKNOWN_HEADER_MAKER).get();
		HeaderDataBlock headerBlock = new HeaderDataBlock(testBlock);
